...
@Composable
fun HomeEtapa3(context: Context, navController: NavController, darkMode: MutableState<Boolean>){
    ...
    //Carga de estados de visualización para videos de la etapa 3
    LaunchedEffect("videos_etapa3") {
    ...
    Scaffold(
        ...
        ContenidoEtapa3(navController=navController,darkMode=darkMode, nota,videos = videos)
    }
}


@Composable
fun ContenidoEtapa3(navController: NavController, darkMode: MutableState<Boolean>, nota:Int,videos: Map<String, Boolean>) {
    Column(
        ...
        // se manda identificador para primer video de la etapa 3.
        BotonClase(NomClase="   Compuertas lógicas básicas    "){
            navController.navigate("pantallaVideo/etapa3_v1")
        }
        Espacio(5.dp)
        ...
        {
            MarcadorClase(videos["etapa3_v1"] == true)
        }
        ...
        BotonClase (NomClase="      Compuertas lógicas universales       " ){
            navController.navigate("pantallaVideo/etapa3_v2")
        }
        Espacio(5.dp)
        Row(
            modifier = Modifier
        ...
        {
            MarcadorClase(videos["etapa3_v2"] == true)
        }
        Espacio(30.dp)

        //Redireccionar a la pantalla para el despliegue de videos,
        // se manda identificador para tercer video de la etapa 3.
        BotonClase (NomClase="     Compuertas lógicas exclusivas     "){
            navController.navigate("pantallaVideo/etapa3_v3")
        }
        Espacio(5.dp)
        Row(
            modifier = Modifier
        ...
        {
            MarcadorClase(videos["etapa3_v3"] == true)
        }
        Espacio(30.dp)


        BotonJuego(NomJuego = "   Representación  de  \n " +
                              "  compuertas lógicas "){
            navController.navigate("GameEtapa3")
        }
        Espacio(5.dp)
        Row(
